...
from convolutions import conv2d, SpatialSeparableConv2d, ACBlock, gaussian_dynamic_conv, deformable_conv, Adaptive_deformable_conv
conv_function = [conv2d.conv2d, SpatialSeparableConv2d.SpatialSeparableConv2d, gaussian_dynamic_conv.gaussian_dynamic_conv, deformable_conv.deformable_conv,Adaptive_deformable_conv.Adaptive_deformable_conv,ACBlock.orgACBlock,ACBlock.ACBlock,ACBlock.GD_AC,ACBlock.D_AC,ACBlock.AD_AC]
